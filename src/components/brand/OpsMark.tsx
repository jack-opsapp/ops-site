 ...
 *
 * Inline SVG so `fill="currentColor"` inherits from parent CSS. Size via
 * width/height, className, or explicit style. Natural aspect ~0.59:1
 * (portrait). Uses the tight bounding viewBox (not the 2400x2400 SVG
 * source) so sizing is predictable.
 */
