 ...
 *
 * Inline SVG so `fill="currentColor"` inherits from parent CSS. Natural aspect
 * ~1.59:1 (landscape). Use for sidebar footers, nav bars at rest, email headers,
 * and any "branded" moment where the full wordmark should read.
 */
