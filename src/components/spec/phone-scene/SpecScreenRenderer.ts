/**
 * SpecScreenRenderer — Canvas 2D orchestrator for SPEC phone screens.
 *
...
import { drawSpecHome } from './screens/spec-home';
import { drawSpecPackages } from './screens/spec-packages';
import { drawSpecAnalysis } from './screens/spec-analysis';
import { drawSpecBuilding } from './screens/spec-building';
import { drawSpecCustom } from './screens/spec-custom';
...
export class SpecScreenRenderer {
  ...
  switchPhase(phase: SpecPhase, tier?: string | null) {
  ...
  switchPhaseInstant(phase: SpecPhase, tier?: string | null) {
